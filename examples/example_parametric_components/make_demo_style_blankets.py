...
def main():
    ...
    # a plasma shape is made and used by the BlanketFP, which builds around the plasma
    ...
    # makes a larger block which has the smaller block cut away and the result is two parallel gaps segments
