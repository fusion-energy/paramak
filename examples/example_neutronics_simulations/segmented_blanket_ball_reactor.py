...
def make_model_and_simulate():
    ...
    center_column_shield_material = nmm.MultiMaterial(
        ...
        materials=[
            ...
            nmm.Material(material_name=center_column_shield_structural_material),
        ],
        fracs=[
    ...
    my_reactor = paramak.BallReactor(
        ...
        firstwall_radial_thickness=3,  # http://www.euro-fusionscipub.org/wp-content/uploads/WPBBCP16_15535_submitted.pdf
