...
class TFCoilCasing(ExtrudeMixedShape):
    ...
    def find_points(self):
        ...
        inner_points_magnet = (inner_points_magnet[:, 0], inner_points_magnet[:, 1])
        outer_points_magnet = (outer_points_magnet[:, 0], outer_points_magnet[:, 1])
    ...
    def create_solid(self):
        ...
        self.leg_shape.azimuth_placement_angle = self.azimuth_placement_angle
