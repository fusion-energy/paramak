...
class CenterColumnStudyReactor(paramak.Reactor):
    ...
    def __init__(
        ...
        inboard_tf_leg_radial_thickness: float = 50.0,
        center_column_shield_radial_thickness_mid: float = 50.0,
        center_column_shield_radial_thickness_upper: float = 100.0,
        inboard_firstwall_radial_thickness: float = 20.0,
        divertor_radial_thickness: float = 100.0,
        inner_plasma_gap_radial_thickness: float = 80.0,
        plasma_radial_thickness: float = 200.0,
        outer_plasma_gap_radial_thickness: float = 90,
        center_column_arc_vertical_thickness: float = 520.0,
    ...
    def _make_vertical_build(self):
        ...
        self._blanket_end_height = self._blanket_start_height + 100.0
    ...
    def _make_center_column_shield(self):
        ...
        self._center_column_shield = paramak.CenterColumnShieldFlatTopHyperbola(
            height=self._center_column_shield_end_height * 2.0,
