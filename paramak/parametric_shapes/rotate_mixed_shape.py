...
class RotateMixedShape(Shape):
    """Rotates a 3d CadQuery solid from points connected with
       ...
       :param points: A list of XZ coordinates and connection types where the last entry 
            has the same XZ coordinates as the first entry. Also the connection types are 
            either 'spline' or 'straight'. For example [(2.,1.,'straight'), (2.,2.,'straight'), 
            (1.,2.,'spline'), (1.,1.,'spline'), (2.,1.,'spline')].
