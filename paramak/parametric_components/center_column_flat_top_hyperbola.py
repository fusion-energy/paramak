...
class CenterColumnShieldFlatTopHyperbola(RotateMixedShape):
    ...
    Args:
        ...
        arc_height (float): height of the outer hyperbolic profile of the center column shield.
        inner_radius (float): the inner radius of the center column shield.
        mid_radius (float): the inner radius of the outer hyperbolic profile of the center
            column shield.
