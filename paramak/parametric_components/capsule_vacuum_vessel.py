...
class CapsuleVacuumVessel(RotateMixedShape):
    ...
    def find_points(self):
        ...
        p2 = (
            (p1[0]) + (radius * math.cos((3 * math.pi) / 8)),
            (p1[1] + radius) - (radius * math.sin((3 * math.pi) / 8)),
            "circle",
        )
        p5 = (
            (p6[0] + (radius * math.cos((2 * math.pi) / 8))),
            (p6[1] - radius) + (radius * math.sin((2 * math.pi) / 8)),
            "circle",
        )
        p8 = (
            (p7[0] + (inner_r * math.cos((2 * math.pi) / 8))),
            (p7[1] - inner_r) + (inner_r * math.sin((2 * math.pi) / 8)),
            "circle",
        )
        p11 = (
            (p12[0]) + (inner_r * math.cos((3 * math.pi) / 8)),
