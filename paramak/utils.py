...
def find_center_point_of_circle(point_a: Tuple[float, float],
                                ...
                                point_c: Tuple[float, float]) -> Tuple[Tuple[float, float], float]:
    """
    ...
    Args:
        ...
        point_c (float, float): point 3 coordinates
    Returns:
    ...
    cd = (temp - point_c[0] * point_c[0] - point_c[1] * point_c[1]) / 2
    det = (point_a[0] - point_b[0]) * (point_b[1] - point_c[1]) - (
        point_b[0] - point_c[0]
    ) * (point_a[1] - point_b[1])
