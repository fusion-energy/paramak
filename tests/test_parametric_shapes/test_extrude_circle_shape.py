...
class TestExtrudeCircleShape(unittest.TestCase):
    def setUp(self):
        self.test_shape = ExtrudeCircleShape(points=[(30, 0)], radius=10, distance=30)
    ...
    def test_intersect_volume(self):
        ...
        intersected and checks that their volumes are correct."""
    ...
    def test_extrude_both(self):
        """Creates an ExtrudeCircleShape with extrude_both = True and False
