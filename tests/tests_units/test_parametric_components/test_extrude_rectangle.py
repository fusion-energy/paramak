...
class TestExtrudeRectangle(unittest.TestCase):
    ...
    def test_absolute_areas(self):
        ...
        assert self.test_shape.areas.count(pytest.approx(60 * 50)) == 2
        assert self.test_shape.areas.count(pytest.approx(50 * 333)) == 2
        assert self.test_shape.areas.count(pytest.approx(60 * 333)) == 2
