...
class TestPoloidalFieldCoilSet(unittest.TestCase):
    ...
    def test_absolute_areas(self):
        ...
        assert self.test_shape.areas.count(pytest.approx(20 * math.pi * (2 * 100))) == 2
        assert self.test_shape.areas.count(pytest.approx(25 * math.pi * (2 * 200))) == 2
    ...
    def test_PoloidalFieldCoilSet_incorrect_height(self):
        ...
        self.assertRaises(ValueError, make_PoloidalFieldCoilSet_incorrect_height)
    ...
    def test_PoloidalFieldCoilSet_incorrect_width(self):
        ...
        self.assertRaises(ValueError, make_PoloidalFieldCoilSet_incorrect_width)
    ...
    def test_PoloidalFieldCoilSet_incorrect_width_length(self):
        ...
        self.assertRaises(ValueError, make_PoloidalFieldCoilSet_incorrect_width_length)
