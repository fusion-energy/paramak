...
class test_object_properties(unittest.TestCase):
    ...
    def test_export_h5m_creates_file(self):
        ...
        test_shape.export_h5m(filename='test_shape.h5m')
    ...
    def test_offset_from_graveyard_sets_attribute(self):
        ...
        test_shape.export_h5m(filename='test_shape.h5m', graveyard_offset=101)
        assert test_shape.graveyard_offset == 101
    ...
    def test_graveyard_offset_increases_voulme(self):
        ...
        test_shape.make_graveyard(graveyard_offset=100)
        small_offset = test_shape.graveyard.volume
        test_shape.make_graveyard(graveyard_offset=1000)
        large_offset = test_shape.graveyard.volume
