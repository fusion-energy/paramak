...
class TestToroidalFieldCoilCoatHanger(unittest.TestCase):
    ...
    def test_default_parameters(self):
        """Checks that the default parameters of a ToroidalFieldCoilCoatHanger
        are correct."""
    ...
    def test_points_calculation(self):
        ...
        ToroidalFieldCoilCoatHanger are calculated correctly from the parameters
        given."""
    ...
    def test_creation_with_inner_leg_with_overlap(self):
        ...
        test_inner_leg = paramak.ExtrudeStraightShape(
            points=[(0, 500), (50, 500), (50, -500), (0, -500)],
            distance=30,
        ...
        assert self.test_shape.area == pytest.approx(
            (
                (
                    (400 * 50 * 2)
                    + (50 * 50 * 0.5 * 2)
                    + (((150 * 250) - (100 * 250 * 0.5) - (100 * 250 * 0.5)) * 2)
                    + (500 * 50)
                )
                * 2
            )
