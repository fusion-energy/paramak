...
def test_perimeter1():
    testp = perimeter(outer_start_point=(0, 0), radius=300, thickness=10)
    assert testp == pytest.approx(3073.54)


def test_perimeter2():
    testp = perimeter(outer_start_point=(100, -100), radius=400, thickness=25)
    assert testp == pytest.approx(4084.734)


def test_perimeter3():
    testp = perimeter(outer_start_point=(1000, -500), radius=5000, thickness=50)
...
def testvolume1():
    testvol = volume(outer_start_point=(0, 0), radius=300, thickness=10, angle=180)
    assert testvol == pytest.approx(11029084.61)


def testvolume2():
    testvol = volume(outer_start_point=(100, -100), radius=400, thickness=25, angle=360)
