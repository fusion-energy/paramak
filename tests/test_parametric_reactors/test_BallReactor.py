...
class test_BallReactor(unittest.TestCase):
    ...
    def test_SegmentedBlanketBallReactor_number_of_blanket_segments_impacts_volume(self):
        ...
        many_segment_reactor = paramak.SegmentedBlanketBallReactor(
            ...
            outboard_tf_coil_poloidal_thickness=50,
            gap_between_blankets=30,
            number_of_blanket_segments=7,
        )

        assert few_segment_reactor._blanket.volume > many_segment_reactor._blanket.volume
        assert few_segment_reactor._firstwall.volume < many_segment_reactor._firstwall.volume
